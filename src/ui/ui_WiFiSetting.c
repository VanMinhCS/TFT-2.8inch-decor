...
void ui_WiFiSetting_screen_init(void)
{
    ...
    ui_object_set_themeable_style_property(ui_WiFiSetting, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_Background);
    ui_object_set_themeable_style_property(ui_WiFiSetting, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
    ...
    ui_object_set_themeable_style_property(ui_WiFiList, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_COLOR,
                                           _ui_theme_color_Background);
    ui_object_set_themeable_style_property(ui_WiFiList, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_OPA,
                                           _ui_theme_alpha_Background);
